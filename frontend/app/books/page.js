    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="relative flex-1 overflow-hidden bg-transparent pt-8 pb-16">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            {isLoadingBooks ? (
              <div className="col-span-full py-8 text-center text-slate-300">Loading books...</div>
            ) : books.length === 0 ? (
              <div className="col-span-full py-8 text-center text-slate-300">No books available yet.</div>
            ) : books.map((book) => (
              <article
                key={book._id}
